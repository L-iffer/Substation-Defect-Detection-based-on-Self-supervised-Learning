...
import SimSiamPro.loader
import SimSiamPro.builder
import SimSiamPro.averCosSim
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = SimSiamPro.builder.SimSiam(
    ...
    criterion = SimSiamPro.averCosSim.averCosineSimilatiry
